...
#speech = gTTS(text = "Alert!")
#speech.save('DataFlair.mp3')
#sound = AudioSegment.from_wav("Ronaldo.wav")
...
def social_distancing_view(frame, distances_mat, boxes, risk_count):
    ...
    cv2.putText(pad, "Social Distance Analyzer", (50, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 2)
