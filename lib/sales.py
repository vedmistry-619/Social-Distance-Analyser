...
class SalesWindow(tk.Frame):
    def __init__(self, master):
        ...
        # Title Label
        title_label = ttk.Label(title_frame, text="INVOICE", font="Arial 60 bold",
                                foreground='#22d3fe')
        ...
        line_label = tk.Label(customer_details_frame, text=("_")*(41),
                                 bg='#fff', fg='#000', bd=0)
        ...
        line_label = tk.Label(customer_details_frame, text=("_")*(41), bg='#fff', fg='#000', bd=0)
        ...
        bill_records_btn = tk.Button(options_frame, image=self.bill_records_btn_img,
                                    bd=0, command=self.bill_records)
        ...
        self.add_to_cart_btn = tk.Button(selection_frame, state='disabled',
                             image=self.add_to_cart_btn_img, bd=0, command=self.add_to_cart)
    ...
    def get_product_details(self, *args):
        ...
        db_obj = db.Database()
        data = self.db_obj.get_product_details(product_selected)
    ...
    def remove_from_cart(self):
        ...
        try:
            ...
            self.db_obj.update_add_product_quantity(selected_prod_qty, selected_prod_name)
            ...
            data = self.db_obj.get_product_details(selected_prod_name)
            self.stock_value.config(text=data[0][2])
