...
class AddProductTopWindow():
    ...
    def __init__(self, master):
        ...
        self.nprod_name_entry = tk.Entry(apw_frame1, font="Arial 20", width=52, bd=0)
        ...
        line_label_full = tk.Label(apw_frame1, text=("_")*(156), bd=0)
        ...
        self.nprod_catname_entry = tk.Entry(apw_frame1, font="Arial 20", width=23, bd=0)
        self.nprod_catname_entry.place(x=70, y=210)
        # Binding keyrelease to check whether the entry is blank or not
        self.nprod_catname_entry.bind("<KeyRelease>", self.secure_entries)
        # Adding line below entry widget to look modern
        line_label_half = tk.Label(apw_frame1, text=("_")*(69), bd=0)
        ...
        self.nprod_subcatname_entry = tk.Entry(apw_frame1, font=('Arial',20), width=23, bd=0)
        ...
        self.nprod_price_entry = tk.Entry(apw_frame1, font="Arial 20", width=23, bd=0)
        ...
        self.nprod_qty_entry = tk.Entry(apw_frame1, font=('Arial',20), width=23, bd=0)
