...
class InventoryWindow(tk.Frame):
    ...
    def __init__(self, master):
        ...
        search_button = tk.Button(product_list_frame, image=self.search_btn_img, bd=0, command=self.search_product)
        ...
        self.selected_prod_name_txt = tk.Text(product_menu_frame, font="Arial 12 bold",bd=0,
        ...
        line_label_half = tk.Label(product_menu_frame, text=("_")*(25), bd=0)
        ...
        select_product_btn = tk.Button(product_menu_frame, image=self.select_product_img,
                                     bd=0, command=self.select_product)
        ...
        viewall_product_btn = tk.Button(product_menu_frame, image=self.view_all_product_img,
                             bd=0, command=lambda : [self.prod_search_entry.delete(0,'end'), self.search_product()])
        ...
        self.update_product_btn = tk.Button(product_menu_frame, image=self.update_product_img,
                                     bd=0, state='disabled', command=self.update_product)
        ...
        delete_product_btn = tk.Button(product_menu_frame, image=self.delete_product_img,
                                     bd=0, command=self.delete_product)
